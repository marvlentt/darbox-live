      ...
      <nav className="fixed top-0 left-0 right-0 z-[100] flex items-center justify-between px-6 lg:px-[60px] py-[18px] bg-[#f5f0e8]/90 backdrop-blur-[12px] border-b border-black/[.06] print:hidden">
        ...
        <div className="hidden lg:flex items-center gap-6">
          ...
          <div className="flex items-center gap-3">
            <Link 
              to="/catalogue" 
              className={`flex items-center gap-2 px-3 py-1.5 rounded-full text-[.85rem] font-bold transition-all duration-300 ${location.pathname === '/catalogue' ? 'bg-[#1a7a4a] text-white shadow-[0_4px_16px_rgba(26,122,74,0.35)]' : 'bg-white shadow-sm border border-black/[0.08] text-[#0d1117] hover:border-[#1a7a4a]/40 hover:text-[#1a7a4a] hover:-translate-y-[1px] hover:shadow-md'}`}
            >
              <FileText className="w-[15px] h-[15px]" /> {t.navCatalogue}
            </Link>
            <Link 
              to="/newsletter" 
              className={`flex items-center gap-2 px-3 py-1.5 rounded-full text-[.85rem] font-bold transition-all duration-300 ${location.pathname === '/newsletter' ? 'bg-[#e0563b] text-white shadow-[0_4px_16px_rgba(224,86,59,0.35)]' : 'bg-white shadow-sm border border-black/[0.08] text-[#0d1117] hover:border-[#e0563b]/40 hover:text-[#e0563b] hover:-translate-y-[1px] hover:shadow-md'}`}
            >
              <Mail className="w-[15px] h-[15px]" /> Newsletter
            </Link>
