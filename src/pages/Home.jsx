    ...
    <>
      ...
      <section id="hero" className="min-h-screen pt-[120px] px-6 lg:px-[60px] pb-20 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-[60px] items-center relative overflow-hidden">
        ...
        <div className="reveal">
          ...
          <div className="flex gap-3.5 items-center flex-wrap">
            ...
            <a href="#how" onClick={e => { e.preventDefault(); go('how'); }} className="border-[1.5px] border-[#ebebeb] text-[#0d1117] px-6 py-3.5 rounded-full font-medium text-[.95rem] no-underline hover:border-[#0d1117] transition-colors">{t.heroCta2}</a>
            <a href="/assets/Catalogue_DarBox_2025.pdf" target="_blank" rel="noopener noreferrer" className="border-[1.5px] border-[#ebebeb] text-[#5a5a5a] px-5 py-3.5 rounded-full font-medium text-[.88rem] no-underline inline-flex items-center gap-2 hover:border-[#1a7a4a] hover:text-[#1a7a4a] hover:bg-[#e8f5ee] transition-all">
      ...
      <div className="bg-[#0d1117] py-16 px-6 lg:px-[60px] border-t border-white/5">
        <div className="max-w-2xl mx-auto text-center reveal">
          ...
          <a href="/assets/Catalogue_DarBox_2025.pdf" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 px-8 py-4 bg-white text-[#0d1117] rounded-full font-bold text-[.95rem] no-underline hover:bg-[#e8f5ee] hover:scale-[1.03] transition-all shadow-[0_4px_24px_rgba(255,255,255,.1)] group">
